...
namespace estate_executor
{
    ...
    {
        int zFamily = zhang::bank_number_part(secret_modifier);
        int kFamily = khan::bank_number_part(secret_modifier);
        int gFamily = garcia::bank_number_part(secret_modifier);
        
        return zFamily + kFamily + gFamily;
    }
